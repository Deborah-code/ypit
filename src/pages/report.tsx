...
function report() {
  return (
    <>
     <main className='bg-purple-100  w-full h-full px-14'>
        <section className='flex flex-col'>
            <div className='flex items-center justify-between px-10 mb-[15px]'>
           <div>
           <h2 className='text-left text-white text-4xl mb-[5px]'>Your career report is ready</h2>
            <p className='text-left text-white text-xl'>Based on your interests, skills and personality traits</p>
           
          </div>
          <button className='border-2 border-white text-white rounded-3xl px-[10px]'>Download</button>
            </div>
           <div className='bg-gray-50 text-black-70 pb-[20px]  flex items-center justify-center gap-16 mx-[25px] rounded-3xl'>
                <div className='flex flex-col items-start justify-start mx-5'>

<div className='flex items-center justify-center mt-[40px]  gap-[20px]'>
...
<p className='text-left text-xl ml-[3.2rem]'>
...
<div className='flex items-start justify-center ml-[60px] mt-[10px]'>
<svg className=' mt-[6px]' width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div className='flex items-start justify-center ml-[60px] mt-[10px]'>
<svg className='w-[17px] mt-[6px]' width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="12" height="12" rx="6" fill="#5100BF" fill-opacity="0.4"/>
<rect x="3" y="3" width="6" height="6" rx="3" fill="#5100BF"/>
</svg>
...
<div className='flex items-start justify-center ml-[60px] mb-[10px] mt-[10px]'>
<svg className='mt-[6px]' 
...
<div className='flex items-start justify-start ml-[60px] mb-[10px]'>
<svg className='mt-[6px]' width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="12" height="12" rx="6" fill="#5100BF" fill-opacity="0.4"/>
<rect x="3" y="3" width="6" height="6" rx="3" fill="#5100BF"/>
</svg>
    ...
    <p className='text-left text-xl'>
       ...
        Focus on the recommended 
        learning paths in data science fundamentals or UX design to align with your top career matches.  </p>
            ...
            <div className='bg-gray-50 text-black-70 mt-3 flex-col items-start justify-center gap-16 mx-[25px] px-10 rounded-3xl'>
...
<h2 className=' text-2xl mb-[10px] '>
          Top career matches</h2>
           ...
           <div className='flex flex-col items-start justify-center ml-[50px]'>
...
<p className='text-xl text-left leading-[30px] mb-[10px]'>
Combines statistics, programming, and domain expertise to extract meaningful<br/> insights from data.
</p>
<p className='text-gray-70 text-[16px] mb-[15px]'> Top Skills required</p>
<ul className='flex items-center justify-center gap-[10px] ml-[20px] mb-[20px]'>
  <li className='bg-gray-75 px-[15px] rounded-lg py-[5px] text-xs'>Python</li>
  <li className='bg-gray-75 px-[15px] rounded-lg py-[5px] text-xs'> Statistics</li>
  <li className='bg-gray-75 px-[15px] rounded-lg py-[5px] text-xs'>Machine Learning</li>
  <li className='bg-gray-75 px-[15px] rounded-lg py-[5px] text-xs'>SQL</li>
</ul>
...
<ul  className='flex items-center justify-center gap-[10px] ml-[20px] mb-[20px]'>
  ...
  <li className='bg-gray-75 px-[15px] rounded-lg py-[5px] text-xs'>Visual design</li>
              ...
              <div className='bg-gray-50 text-black-70 mt-3 mb-[50px] flex-col items-start justify-center gap-16 mx-[25px] px-10 rounded-3xl'>
            <div className='flex items-start justify-start mt-[40px]  gap-[20px]'>
<svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M24 0.5H32V8.5H24V0.5ZM16 8.5H0V16.5H10.8333L5.89665 22.4814C5.3756 23.1129 4.72137 23.6213 3.9808 23.9703C3.24023 24.3193 2.43165 24.5001 1.61297 24.5H0V32.5H2.85059C6.11114 32.5 9.20216 31.0436 11.2778 28.5285L16 22.8075V32.5H24V8.5H16Z" fill="#5100BF" />
          </svg>
...
<p className='text-xl text-left leading-[30px] mb-[20px]'>
Comprehensive overview of data science fundamentals
</p>

<h2 className='flex items-center justify-center gap-[15px] text-xl font-[600]'>Google UX Design Certificate <span className="bg-gray-150/20 px-[10px] py-[5px] rounded-lg text-xs font-[400]">Certificate</span></h2>
<p className='text-xl text-left leading-[30px] mb-[20px]'>
Comprehensive overview of data science fundamentals
</p>
<p className='text-gray-70 text-[16px] mb-[3px] italic'>Looking for more learning resources?</p>
<p className='mb-[10px]'>Explore additional courses on Coursera, edX, and other leading platforms</p>
