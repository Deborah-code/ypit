...
export default function CareerMatchesSection({
  ...
  return (
    <div className="bg-[#ECECEC] text-black-70 mt-[70px] flex-col items-start justify-start gap-16 mx-[25px] px-10 rounded-xl max-sm:mx-[8px] max-sm:px-[5px]">
      <div className="flex items-start justify-start mt-[40px] gap-[20px]">
        <Image src={Pointer as StaticImageData} alt="pointer" />
      ...
      <div className="flex flex-col items-start justify-start ml-[56px] max-sm:ml-[10px]">
        {careerMatches.map((match, index) => (
          <div key={index} className="mb-[30px]">
            <h2 className="flex items-center justify-start py-[8px] gap-[15px] text-xl font-[600]">
              {match.role}
